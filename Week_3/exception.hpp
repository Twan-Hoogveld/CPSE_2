...
{
public:
    unknown_color(const std::string &name) : s{std::string{"unknown color ["} + name + "]"}
    {
    }
...
{
public:
    unknown_shape(const std::string &name) : s{std::string{"unknown shape ["} + name + "]"}
    {
    }
    const char *what() const noexcept override
    {
...
{
public:
    invalid_position(const char &name) : s{std::string{"invalid position ["} + name + "]"}
    {
    }
    const char *what() const noexcept override
    {
